...
import lucdeb.commands.qe.RelevanceBasedLanguageModel;
...
public class ExpansionCommand extends Commands {
    ...
    public ExpansionCommand(LucDebObjects lucivObjects) {
    ...
    @Override
    public String usage() {
        return "expansion - <query-terms> [<number of expansion terms> (default 10)]";
    }
