...
import lucdeb.commands.CollectionFrequencyCommand;
import lucdeb.commands.Commands;
import lucdeb.commands.CompareCommand;
import lucdeb.commands.CustomLMJMSim;
import lucdeb.commands.DocLengthCommand;
import lucdeb.commands.DocLengthNameCommand;
import lucdeb.commands.DocTermsCommand;
import lucdeb.commands.DocVectorCommand;
import lucdeb.commands.DocVectorNameCommand;
import lucdeb.commands.DocumentFrequencyCommand;
import lucdeb.commands.DumpCommand;
import lucdeb.commands.ExpansionCommand;
import lucdeb.commands.ExplainCommand;
import lucdeb.commands.HelpCommand;
import lucdeb.commands.Postings;
import lucdeb.commands.QuitLucDeb;
import lucdeb.commands.RankCommand;
import lucdeb.commands.SearchCommand;
import lucdeb.commands.SetRetrievalModelCommand;
import lucdeb.commands.SetSearchFieldCommand;
import lucdeb.commands.StatsCommand;
import lucdeb.commands.TermFrequencyCommand;
import lucdeb.commands.TermFrequencyNameCommand;
import lucdeb.commands.VocabCommand;
 ...
 * @author dwaipayan
 */
public final class LucDebObjects {
    ...
    public void init() {
        ...
        prop = new Properties();
        try {
            prop.load(new FileReader("/user1/faculty/cvpr/irlab/sourav/init.properties"));
    ...
    public LucDebObjects(String indexPath) throws IOException, Exception {
