...
public class TRECQueryParser extends DefaultHandler {
    ...
    public HashMap<Integer,TRECQuery>  queries;
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (qName.equalsIgnoreCase("title")) {
            ...
            try {
                query.luceneQuery = query.getBOWQuery(analyzer, query, fieldToSearch);
                //System.out.println(query.luceneQuery.toString(fieldToSearch));
            } catch (Exception ex) {
                System.err.println("Exception while reading query");
            }
            queries.put(Integer.parseInt(query.qid), query);
        }        
    }
...
//            .replaceAll("\\?", " ").replaceAll("\"", " ").replaceAll("\\&", " "), fieldToSearch);
    ...
    public HashMap<Integer, TRECQuery> constructQueries() throws Exception {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /*
            for (Map.Entry<Integer, TRECQuery> entrySet : queries.entrySet()) {
                //            for (TRECQuery query : queryParser.queries) {
                System.out.print(entrySet.getKey() + " ");
                //                System.out.println("Title: "+query.qtitle);
                Query luceneQuery;
                luceneQuery = queryParser.getAnalyzedQuery(entrySet.getValue());
